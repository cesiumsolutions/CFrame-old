# ------------------------------------------------------------------------------
# @brief Encapsulates many of the common elements for setting up a build target.
# @ingroup targets
#
# Options:
...
#
#   CFRAME_TARGETS_FLAT_SOURCE_TREE   - whether to use a flat organization structure for the source (for IDE build environments)
#   CFRAME_MESSAGE_VERBOSITY
#   CFRAME_OS_COMPILE_FLAGS
#   CFRAME_TARGETS_INSTALL_BIN_DIR
#   CFRAME_TARGETS_INSTALL_LIB_DIR
#   CFRAME_TARGETS_INSTALL_DEV_DIR
#
...
# -----------------------------------------------------------------------------
function( cframe_target )

  cframe_message(
      MODE STATUS
      TAGS CFrame Targets
      VERBOSITY 3
      MESSAGE "FUNCTION: cframe_build_target()"
  )
...
##  cframe_filter_list( _QT5_QRCFILES    CFRAME_FILE_EXCLUDE_LIST )
  ...
  if ( cframe_build_target_QT_MOCFILES )
    ...
    if ( CFRAME_TARGETS_FLAT_SOURCE_TREE )
      source_group(
...
##    endif() # Test type
  ...
  if ( NOT cframe_build_target_NO_INSTALL AND
      ...
      install(
          ...
          RUNTIME DESTINATION ${BINARY_INSTALL_PREFIX}${CFRAME_TARGETS_INSTALL_BIN_DIR} COMPONENT Runtime
          LIBRARY DESTINATION ${BINARY_INSTALL_PREFIX}${CFRAME_TARGETS_INSTALL_LIB_DIR} COMPONENT Runtime
          ARCHIVE DESTINATION ${BINARY_INSTALL_PREFIX}${CFRAME_TARGETS_INSTALL_DEV_DIR} COMPONENT Development
      )
  endif()
